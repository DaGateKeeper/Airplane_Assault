...
public class Enemy extends BaseActor
{
    ...
    public Enemy(int p, Stage stage)
    {
        ...
        setAnimator( new Animator("assets/enemy-plane.png") );
        setSize(80,80);
        time = 0;
        shootTimer = 0;
        ...
        else if (preset == 2)
        {
            ...
            setAnimator( new Animator("assets/enemy-plane-red.png") );
        }
        else if (preset == 3)
        {
            function = new SinePath();
                        setAnimator( new Animator("assets/enemy-plane-green.png") );
        }
        else if (preset == 4)
        {
            time = -2;
            function = new HourglassPath();
            setAnimator( new Animator("assets/player-violet.png") );
        }
    }
    ...
    public void act(float dt)
    {
        ...
        // if ( shootTimer > 4 && this.getY() > player.getY())
        // {
